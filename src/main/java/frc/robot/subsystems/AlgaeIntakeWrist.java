...
public class AlgaeIntakeWrist extends SubsystemBase{
    ...
    public AlgaeIntakeWrist(){
        ...
        m_motor.getConfigurator().apply(new AlgaeIntakeWristConfig(100.0,95.0,160.0,80.0,InvertedValue.Clockwise_Positive,NeutralModeValue.Brake));
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("algea wrist acc", acc.getValueAsDouble());
    }
